package com.shubham.musicplayer.Activity;
...
import com.shubham.musicplayer.Adapter.ViewPagerAdapter;
import com.shubham.musicplayer.DB.FavoritesOperations;
import com.shubham.musicplayer.Fragments.AllSongFragment;
import com.shubham.musicplayer.Fragments.CurrentSongFragment;
import com.shubham.musicplayer.Fragments.FavSongFragment;
import com.shubham.musicplayer.Model.SongsList;
import com.shubham.musicplayer.R;
    ...
    private void grantedPermission() {
        if (ContextCompat.checkSelfPermission(MainActivity.this,
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(MainActivity.this,
                ...
                if (ContextCompat.checkSelfPermission(MainActivity.this,
                        Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                    Snackbar snackbar = Snackbar.make(mDrawerLayout, "Please Provide the Storage Permission", Snackbar.LENGTH_LONG);
                    snackbar.show();
                }
            }
        } else {
...
//   Merging page layout with viewpager
    ...
    private void about() {
        ...
        builder.setTitle(getString(R.string.about))
                .setMessage("This App Is Created By Shubham and There Are Some minor UI issues and Some Stability issues. \n Hope it will be get fixed in Next Build. \n ~Shubham")
    ...
    private void notice() {
        ...
        builder.setTitle("Notice")
                .setMessage("Major Issues:- Repeat songs Not Working \n 1.There Are Some Minor Stablity Issues. \n 2.There Are Some UI Overlapped and Related to This Issues. \n 3.Sorting Songs not Working \n 4.Due to Android Restrictions Material Ui Not Added \n All This Bugs Will Be Fixed By 4 july, \n ~Shubham")
    ...
    private  void rate(){
        ...
        builder.setTitle("Rate App")
                .setMessage("Link soon To Be Added \n ~Shubham")
...
//Below Function is Used to add controls
//
    @Override
        ...
        switch (v.getId()) {
            ...
            case R.id.img_btn_replay:
                if (repeatFlag){
                    ...
                    Toast.makeText(this, "Replaying Stopped" , Toast.LENGTH_SHORT).show();
...
//
//BElow Function Is USed To add SOngs In Player
...
// TO Receiver Data From Fragements
